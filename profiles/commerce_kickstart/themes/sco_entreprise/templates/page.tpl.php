	...
	<section id="content" class="">
			...
			<div class="container">
				...
				<?php endif; ?>
					...
					<?php if(isset($term) && $term->vocabulary_machine_name=="partenaires"): ?>
					<div class="retour">
					<a href="/<?php print $language->language; ?>/espace-entreprise/annuaire"><?php print t("return to list of partners"); ?></a>
					</div>
					<?php endif; ?>
     ...
     <?php endif; ?>
		...
		<div class="">
			...
			<div class="network">
				...
				<div class="item twitter"><a href="<?php echo theme_get_setting('twitter','sco'); ?>">Facebook</a></div>
				<div class="item instagram"><a href="<?php echo theme_get_setting('instagram','sco'); ?>">Facebook</a></div>
			</div>
			</div>
